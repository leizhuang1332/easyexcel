...
public class EasyExcelFactory {
    ...
    public static ExcelWriterBuilder write(String pathName, Class head) {
        return write(pathName, head, null);
    }
     ...
     * @return Excel writer builder
     */
    public static ExcelWriterBuilder write(String pathName, Class head, Map<String, Object> param) {
        return write(pathName, head, param, null);
    }
     ...
     * @return Excel writer builder
     */
    public static ExcelWriterBuilder write(String pathName, Class head, Map<String, Object> param, Translator translator) {
        return write(pathName, head, param, translator, true);
    }
    ...
    public static ExcelWriterBuilder write(String pathName, Class head, Map<String, Object> param, Translator translator, boolean isFieldCache) {
        ...
        if (param != null) {
            excelWriterBuilder.param(param);
        }
        if (translator != null) {
            excelWriterBuilder.translator(translator);
        }
        excelWriterBuilder.isFieldCache(isFieldCache);
        return excelWriterBuilder;
    }

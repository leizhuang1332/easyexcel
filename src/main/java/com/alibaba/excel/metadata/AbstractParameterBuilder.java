...
public abstract class AbstractParameterBuilder<T extends AbstractParameterBuilder, C extends BasicParameter> {
    ...
    public T param(Map<String, Object> param) {
        parameter().setParam(param);
        return self();
    }

    public T translator(Translator translator) {
        parameter().setTranslator(translator);
        return self();
    }

    public T isFieldCache(boolean isFieldCache) {
        parameter().setIsFieldCache(isFieldCache);
        return self();
    }

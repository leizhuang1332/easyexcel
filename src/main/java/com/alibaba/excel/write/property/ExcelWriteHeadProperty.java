...
public class ExcelWriteHeadProperty extends ExcelHeadProperty {
    ...
    public ExcelWriteHeadProperty(Holder holder, Class headClazz, List<List<String>> head, Boolean convertAllFiled, Map<String, Object> param, Translator translator) {
        super(holder, headClazz, head, convertAllFiled, param, translator);
